...
# add a hover tool
fig_cuisine_time.add_tools(HoverTool(tooltips=[("Cuisine", "@cuisine"), ("Average time taken to cook", "@total_time")]))
...
# add a hover tool
fig_diet_time.add_tools(HoverTool(tooltips=[("Diet", "@diet"), ("Average time taken to cook", "@total_time")]))
...
# add a hover tool
fig_cuisine_rating.add_tools(HoverTool(tooltips=[("Cuisine", "@cuisine"), ("Average rating", "@rating")]))
...
# add a hover tool
fig_diet_rating.add_tools(HoverTool(tooltips=[("Diet", "@diet"), ("Average rating", "@rating")]))
...
def get_recipes_with_ingredients(ingredients):
    ...
    for ingredient in ingredients.split(' '):
        ...
        recipes.append(df[df['ingredients'].str.contains(ingredient)]['recipe_title'].tolist())
...
def get_random_cuisine_recipes(cuisine, n=5):
    ...
    if cuisine not in df['cuisine'].unique():
...
def get_recipe_info(recipe_name):
        ...
        recipe = recipe[['cuisine', 'course', 'diet', 'ingredients', 'instructions', 'total_time']]
