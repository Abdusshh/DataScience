...
st.set_page_config(
    page_title="Food Recipe Dashboard", page_icon=":shallow_pan_of_food:", layout="wide"
)
...
# load the lottie animation from the url and return the json
...
lottie_coding_food = load_lottieurl(
    "https://assets6.lottiefiles.com/packages/lf20_qX4zwY.json"
)

# lets create columns for the lotte animation and the title
...
with col1:
    ...
    st.markdown("###")
    st.markdown(
        "## Get Your Recipe of Choice <a name='get_recipes'></a>",
...
with col2:
    st_lottie(lottie_coding_food, height=200, key="initial")
...
lottie_coding_research = load_lottieurl(
    "https://assets2.lottiefiles.com/packages/lf20_bdlrkrqv.json"
)
...
with col1:
    ...
    st.markdown("###")
    st.markdown(
        "## Research Introduction <a name='introduction'></a>", unsafe_allow_html=True
    )
with col2:
    st_lottie(lottie_coding_research, height=200, key="second")

st.markdown("#### What is the purpose of this research?")
st.write(
    """The purpose of this research is to provide a visual representation of the data collected from the Food Recipes dataset. The data is presented in a way that is easy to understand and interpret, and can be used to answer questions about the dataset."""
)
st.markdown("###")
...
st.markdown(
    "##### [2. Which cuisines require the longest cooking time?](#cuisine_time)"
)
...
st.markdown(
    "### 1. Which cuisines receive the highest ratings? <a name='cuisine_rating'></a>",
    unsafe_allow_html=True,
)
...
st.markdown(
    "### 2. Which cuisines require the longest cooking time? <a name='cuisine_time'></a>",
    unsafe_allow_html=True,
)
...
with col1:
    st.markdown(
        "### 3. Which diets receive the highest ratings? <a name='diet_rating'></a>",
        unsafe_allow_html=True,
    )
...
with col2:
    st.markdown(
        "### 4. Which diets require the longest cooking time? <a name='diet_time'></a>",
        unsafe_allow_html=True,
    )
